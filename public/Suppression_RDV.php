...
$sql = "SELECT r.id_rendez_vous, r.date_rdv, r.mode_consultation, r.status_rdv, CONCAT(e.prenom, ' ', e.nom) AS etudiant, CONCAT(p.prenom, ' ', p.nom) AS professionnel, p.specialiste FROM RENDEZ_VOUS r JOIN ETUDIANT e ON r.id_etudiant = e.id_etudiant JOIN PROFESSIONEL p ON r.id_professionel = p.id_professionelORDER BY r.date_rdv";
$rdvs = $pdo->query($sql);
?>
<!DOCTYPE html>
<html lang="fr">
